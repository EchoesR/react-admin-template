...
export default class extends React.Component {
  ...
  render() {
    return (
      <svg t="1508738709248" onClick={this.click} className={this.props.className} style={screenfullStyles} viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="2069" xlinkHref="http://www.w3.org/1999/xlink" width="32" height="32">
